...
const Links = computed(() => [
    ...
    { name: t("pages.links.items.college"), url: 'https://cai.jxufe.edu.cn/', icon: official_icon },
    { name: t("pages.links.items.zsjy"), url: 'https://zsjy.jxufe.edu.cn/', icon: official_icon },
    { name: t("pages.links.items.hello"), url: 'http://hello.jxufe.edu.cn/', icon: official_icon },
    {
...
const iLinks = computed(() => [
    { name: t("pages.links.items.ctfplatform"), url: 'http://172.28.52.11/', icon: '/favicon.svg' },
    { name: t("pages.links.items.cloud"), url: 'http://172.28.52.13/', icon: '/favicon.svg' }
])
...
const fLinks: Link[] = [
    ...
    },
    {
        ...
        url: 'https://npiter.de/',
        icon:
            'https://upload-bbs.miyoushe.com/upload/2025/01/13/363839390/3b27ef57435c87542b43e4fecdabc040_3189688091243815374.png?x-oss-process=image//resize,s_600/quality,q_80/auto-orient,0/interlace,1/format,png'
    }
];
