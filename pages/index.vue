            ...
            <div class="w-full md:w-1/2 max-w-2xl bg-white dark:bg-[#1E1E1E]  p-8 rounded-xl shadow-lg">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span
                            class="px-3 py-1 bg-[#f7fbff] text-[var(--color-primary-pressed)] rounded-full text-sm font-medium hover:bg-[var(--color-primary)] hover:text-white transition-colors">CISCN</span>
                        <span
