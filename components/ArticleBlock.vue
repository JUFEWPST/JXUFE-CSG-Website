    ...
    <li class="list-none">
        <NuxtLink :to="linkto"
            ...
            <div class="absolute top-5 right-6 w-6 h-6" v-if="istop">
                <svg t="1752824665138" class="icon text-[var(--anzu-primary)]" viewBox="0 0 1024 1024" version="1.1"
            ...
            <div
                class="post-meta-bar flex select-none flex-wrap items-center justify-end gap-4 text-gray-500 dark:text-gray-300 mt-4">
                <div class="flex min-w-0 shrink grow flex-wrap gap-2 text-sm">
                    <div class="flex min-w-0 items-center space-x-1">
                        <svg width="1em" height="1em" viewBox="0 0 24 24" class="text-[var(--anzu-primary)]">
                            <path fill="currentColor"
                    ...
                    <div class="flex min-w-0 items-center space-x-1" v-if="tags">
                        <svg width="1em" height="1em" viewBox="0 0 24 24"
                            class="translate-y-[0.5px] text-[var(--anzu-primary)]">
