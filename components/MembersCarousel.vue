<template>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-center">
            <AnzuComboBox v-model="selectedYear" :items="yearOptions" value-key="value" label-key="label"
                placeholder="选择届数" search-placeholder="搜索届数..." menu-width-class="w-48" maxMenuHeight="10rem"
