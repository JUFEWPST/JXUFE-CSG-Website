        ...
        >
            ...
            >
                ...
                <NuxtLink
                    ...
                    :to="item.to"
                    class="hover:text-(--md-sys-color-on-surface) hover:bg-black/5 dark:hover:bg-white/5 rounded-lg px-2 py-1 -mx-2 transition-all duration-200 flex items-center gap-1.5 cursor-pointer font-medium"
